...
const commentsController = {
    ...
    modifyComment: async (req, res) => {
        ...
        try {
            const modifiedComment = await ItinerariesControl.findOneAndUpdate({"comments._id": commentId}, {$set: {"comments.$.comment": comment}}, {new: true}).populate("comments.userId", {photoURL: 1, firstName: 1, lastName: 1})
            modifiedComment.save()
