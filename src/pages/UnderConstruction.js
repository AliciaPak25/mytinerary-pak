...
{/* <h1 key={itinerary._id}>{itinerary.name}</h1> */}
  {/*  <div className="CardDetails">
      <div class="card bg-dark text-white cardCityDetail">
        <img src={process.env.PUBLIC_URL+`/assets/${props.city.image}`} class="card-img" alt="cityPhotoDetail" className='cityPhotoDetail'/>
